...
<body>
    ...
    <div class="bubble hydro">
        ...
        <br \>
        <center><div class="title">THE FONT</div>
    ...
    <div class="bubble data">
        ...
        <br \>
        <center><div class="title">THE CATHEDRAL</div>
    ...
    <div class="bubble sate">
        ...
        <br \>
        <center><div class="title">THE RELIQUARY</div>
    ...
    <div class="bubble last">
        ...
        <br \>
        <center><div class="title">THE BASILICA</div>
        ...
        <div class = "wrap">
        <button class="continueButton" type="button">Finish</button>
        </div>
